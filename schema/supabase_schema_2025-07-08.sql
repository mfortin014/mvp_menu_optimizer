...
--
-- Name: ingredients_duplicate; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ingredients_duplicate (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    ingredient_code text NOT NULL,
    name text NOT NULL,
    ingredient_type text NOT NULL,
...
--
-- Name: TABLE ingredients_duplicate; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.ingredients_duplicate IS 'This is a duplicate of ingredients';
...
CREATE TABLE public.recipes (
    ...
    is_service_recipe boolean DEFAULT true NOT NULL,
    is_ingredient_recipe boolean DEFAULT false NOT NULL
);
...
CREATE VIEW public.recipe_line_costs AS
 SELECT rl.id AS recipe_line_id,
    ...
    i.yield_pct,
        CASE
            WHEN ((i.package_qty > (0)::numeric) AND ((rl.qty_uom = i.package_uom) OR (c.factor IS NOT NULL))) THEN
            CASE
...
CREATE VIEW public.recipe_summary AS
 SELECT r.id AS recipe_id,
    ...
    (r.price - COALESCE(sum(rlc.line_cost), (0)::numeric)) AS margin_dollar,
        CASE
            WHEN (r.price > (0)::numeric) THEN ((r.price - COALESCE(sum(rlc.line_cost), (0)::numeric)) / r.price)
            ELSE (0)::numeric
        END AS profitability,
    COALESCE(s.total_units_sold, (0)::numeric) AS popularity
   FROM ((public.recipes r
     LEFT JOIN public.recipe_line_costs rlc ON ((rlc.recipe_id = r.id)))
     LEFT JOIN ( SELECT sales.recipe_id,
            sum(sales.qty) AS total_units_sold
           FROM public.sales
          GROUP BY sales.recipe_id) s ON ((s.recipe_id = r.id)))
  GROUP BY r.id, r.name, r.price, s.total_units_sold;


--
-- Name: recipe_as_ingredient_cost; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.recipe_as_ingredient_cost AS
 SELECT r.id AS recipe_id,
    r.recipe_code,
    r.name,
    r.base_yield_qty,
    ...
    (r.base_yield_qty * c.factor) AS yield_qty_in_base_unit,
        CASE
            WHEN ((r.base_yield_qty * c.factor) > (0)::numeric) THEN (rs.cost / (r.base_yield_qty * c.factor))
            ELSE NULL::numeric
        END AS unit_cost,
    c.to_uom AS base_uom
   FROM ((public.recipes r
     JOIN public.recipe_summary rs ON ((rs.recipe_id = r.id)))
     LEFT JOIN public.ref_uom_conversion c ON ((r.base_yield_uom = c.from_uom)))
  WHERE ((r.is_ingredient_recipe = true) AND (r.status = 'Active'::text));


--
-- Name: recipe_lines_duplicate; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.recipe_lines_duplicate (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    recipe_id uuid,
    ingredient_id uuid,
    qty numeric,
...
--
-- Name: TABLE recipe_lines_duplicate; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.recipe_lines_duplicate IS 'This is a duplicate of recipe_lines';


--
-- Name: recipes_duplicate; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.recipes_duplicate (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    recipe_code text NOT NULL,
    name text NOT NULL,
    status text DEFAULT 'Active'::text,
...
--
-- Name: TABLE recipes_duplicate; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.recipes_duplicate IS 'This is a duplicate of recipes';


--
-- Name: COLUMN recipes_duplicate.recipe_category; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.recipes_duplicate.recipe_category IS 'Free-form text category used for filtering, tagging, and grouping recipes.';
...
--
-- Name: ingredients_duplicate ingredients_duplicate_ingredient_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ingredients_duplicate
    ADD CONSTRAINT ingredients_duplicate_ingredient_code_key UNIQUE (ingredient_code);


--
-- Name: ingredients_duplicate ingredients_duplicate_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ingredients_duplicate
    ADD CONSTRAINT ingredients_duplicate_pkey PRIMARY KEY (id);
...
--
-- Name: recipe_lines_duplicate recipe_lines_duplicate_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recipe_lines_duplicate
    ADD CONSTRAINT recipe_lines_duplicate_pkey PRIMARY KEY (id);
...
--
-- Name: recipes_duplicate recipes_duplicate_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recipes_duplicate
    ADD CONSTRAINT recipes_duplicate_pkey PRIMARY KEY (id);


--
-- Name: recipes_duplicate recipes_duplicate_recipe_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recipes_duplicate
    ADD CONSTRAINT recipes_duplicate_recipe_code_key UNIQUE (recipe_code);
...
--
-- Name: ingredients_duplicate ingredients_duplicate_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ingredients_duplicate
    ADD CONSTRAINT ingredients_duplicate_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.ref_ingredient_categories(id);


--
-- Name: ingredients_duplicate ingredients_duplicate_storage_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ingredients_duplicate
    ADD CONSTRAINT ingredients_duplicate_storage_type_id_fkey FOREIGN KEY (storage_type_id) REFERENCES public.ref_storage_type(id);
...
--
-- Name: recipe_lines_duplicate recipe_lines_duplicate_ingredient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recipe_lines_duplicate
    ADD CONSTRAINT recipe_lines_duplicate_ingredient_id_fkey FOREIGN KEY (ingredient_id) REFERENCES public.ingredients(id) ON DELETE RESTRICT;


--
-- Name: recipe_lines_duplicate recipe_lines_duplicate_recipe_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recipe_lines_duplicate
    ADD CONSTRAINT recipe_lines_duplicate_recipe_id_fkey FOREIGN KEY (recipe_id) REFERENCES public.recipes(id) ON DELETE CASCADE;


--
-- Name: recipe_lines recipe_lines_ingredient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recipe_lines
    ADD CONSTRAINT recipe_lines_ingredient_id_fkey FOREIGN KEY (ingredient_id) REFERENCES public.ingredients(id) ON DELETE RESTRICT;
...
--
-- Name: ingredients_duplicate; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.ingredients_duplicate ENABLE ROW LEVEL SECURITY;

--
-- Name: recipe_lines_duplicate; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.recipe_lines_duplicate ENABLE ROW LEVEL SECURITY;

--
-- Name: recipes_duplicate; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.recipes_duplicate ENABLE ROW LEVEL SECURITY;
