...
-- Schema dump
-- Env: PROD
-- Bitwarden project: a986624c-f0b9-49cc-9660-b37700dee9b4
-- Mode: release
-- Timestamp (local): 2025-10-27_1158
-- Git commit: f140a16
-- Release Tag: mvp-0.7.1
-- ------------------------------------------------------------
--
-- PostgreSQL database dump
--

\restrict cq2qSXmrUupGNyo6u56jgtaDq4yaxTV1te99oelT4r2PmMlMMRH8tVwVU7Srwm3
...
--
-- Name: enforce_same_tenant_sales(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.enforce_same_tenant_sales() RETURNS trigger
    LANGUAGE plpgsql
    SET search_path TO 'public', 'pg_temp'
    AS $$
...
CREATE VIEW public.ingredient_costs WITH (security_invoker='true') AS
 SELECT i.tenant_id,
...
CREATE VIEW public.input_catalog WITH (security_invoker='true') AS
 SELECT i.tenant_id,
    i.id,
    i.ingredient_code AS code,
    i.name,
...
CREATE VIEW public.missing_uom_conversions WITH (security_invoker='true') AS
 SELECT rl.tenant_id,
...
CREATE VIEW public.recipe_line_costs_base WITH (security_invoker='true') AS
 SELECT rl.tenant_id,
    rl.id AS recipe_line_id,
    rl.recipe_id,
    rl.ingredient_id,
...
CREATE VIEW public.prep_costs WITH (security_invoker='true') AS
...
CREATE VIEW public.recipe_line_costs WITH (security_invoker='true') AS
 SELECT rl.tenant_id,
    rl.id AS recipe_line_id,
    rl.recipe_id,
    rl.ingredient_id,
...
ALTER TABLE ONLY public.user_tenant_memberships
    ADD CONSTRAINT user_tenant_memberships_pkey PRIMARY KEY (user_id, tenant_id);
...
--
-- Name: idx_recipe_lines_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_recipe_lines_tenant ON public.recipe_lines USING btree (tenant_id);


--
-- Name: idx_recipe_lines_tenant_ingredient; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_recipe_lines_tenant_ingredient ON public.recipe_lines USING btree (tenant_id, ingredient_id);


--
-- Name: idx_recipe_lines_tenant_recipe; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_recipe_lines_tenant_recipe ON public.recipe_lines USING btree (tenant_id, recipe_id);
...
--
-- Name: idx_ref_ingredient_categories_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ref_ingredient_categories_tenant ON public.ref_ingredient_categories USING btree (tenant_id);


--
-- Name: idx_ref_storage_type_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ref_storage_type_tenant ON public.ref_storage_type USING btree (tenant_id);
...
--
-- Name: idx_sales_tenant_recipe; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_tenant_recipe ON public.sales USING btree (tenant_id, recipe_id);
...
CREATE UNIQUE INDEX ux_ingredients_tenant_code ON public.ingredients USING btree (tenant_id, ingredient_code);
...
CREATE UNIQUE INDEX ux_recipes_tenant_code ON public.recipes USING btree (tenant_id, recipe_code);
...
--
-- Name: recipe_lines tr_recipe_lines_tenant_guard; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER tr_recipe_lines_tenant_guard BEFORE INSERT OR UPDATE ON public.recipe_lines FOR EACH ROW EXECUTE FUNCTION public.enforce_same_tenant_recipe_lines();


--
-- Name: sales tr_sales_tenant_guard; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: ingredients ingredients_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ingredients
    ADD CONSTRAINT ingredients_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE RESTRICT;
...
--
-- Name: recipe_lines recipe_lines_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recipe_lines
    ADD CONSTRAINT recipe_lines_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE RESTRICT;


--
-- Name: recipes recipes_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recipes
    ADD CONSTRAINT recipes_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE RESTRICT;


--
-- Name: ref_ingredient_categories ref_ingredient_categories_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ref_ingredient_categories
    ADD CONSTRAINT ref_ingredient_categories_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE RESTRICT;


--
-- Name: ref_storage_type ref_storage_type_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sales sales_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.user_tenant_memberships
    ADD CONSTRAINT user_tenant_memberships_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id) ON DELETE CASCADE;
...
--
-- Name: schema_migrations deny all on schema_migrations; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ingredients p_modify_all_ingredients; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY p_modify_all_ingredients ON public.ingredients USING (true) WITH CHECK (true);


--
-- Name: user_tenant_memberships p_modify_all_memberships; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY p_modify_all_memberships ON public.user_tenant_memberships USING (true) WITH CHECK (true);


--
-- Name: recipe_lines p_modify_all_recipe_lines; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY p_modify_all_recipe_lines ON public.recipe_lines USING (true) WITH CHECK (true);


--
-- Name: recipes p_modify_all_recipes; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY p_modify_all_recipes ON public.recipes USING (true) WITH CHECK (true);


--
-- Name: ref_ingredient_categories p_modify_all_refcat; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY p_modify_all_refcat ON public.ref_ingredient_categories USING (true) WITH CHECK (true);


--
-- Name: ref_storage_type p_modify_all_refstore; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY p_modify_all_refstore ON public.ref_storage_type USING (true) WITH CHECK (true);


--
-- Name: sales p_modify_all_sales; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY p_modify_all_sales ON public.sales USING (true) WITH CHECK (true);


--
-- Name: tenants p_modify_all_tenants; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY p_modify_all_tenants ON public.tenants USING (true) WITH CHECK (true);


--
-- Name: ingredients p_select_all_ingredients; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_tenant_memberships p_select_all_memberships; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: recipe_lines p_select_all_recipe_lines; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: recipes p_select_all_recipes; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ref_ingredient_categories p_select_all_refcat; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ref_storage_type p_select_all_refstore; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: sales p_select_all_sales; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: tenants p_select_all_tenants; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles profiles write own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ref_ingredient_categories; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.ref_ingredient_categories ENABLE ROW LEVEL SECURITY;

--
-- Name: ref_storage_type; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.ref_storage_type ENABLE ROW LEVEL SECURITY;

--
-- Name: ref_uom_conversion; Type: ROW SECURITY; Schema: public; Owner: -
--
...
\unrestrict cq2qSXmrUupGNyo6u56jgtaDq4yaxTV1te99oelT4r2PmMlMMRH8tVwVU7Srwm3
