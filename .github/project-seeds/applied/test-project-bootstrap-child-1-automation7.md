<!--
title: Configure test project automation smoke checks - 7
labels: ["test"]
assignees: ["mfortin014"]
uid: test-project-bootstrap-child-1-automation-7
parent_uid: test-project-bootstrap-epic-7
type: Chore
status: Draft
priority: P1
area: ci
...
# Configure test project automation smoke checks - 7
