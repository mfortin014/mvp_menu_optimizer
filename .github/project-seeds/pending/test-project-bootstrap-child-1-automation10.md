<!--
title: Configure test project automation smoke checks - 10
labels: ["test"]
assignees: ["mfortin014"]
uid: test-project-bootstrap-child-1-automation-10
...
# Configure test project automation smoke checks - 10
